...
*TeamApi* | [**team_get_matches**](docs/apis/tags/TeamApi.md#team_get_matches) | **get** /teams/{id}/matches | 
...
If the OpenAPI document is large, imports in rec.apis and rec.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from rec.apis.default_api import DefaultApi`
- `from rec.model.pet import Pet`
